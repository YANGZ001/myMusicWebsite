  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-button type="primary" size="mini" @click="centerDialogVisible = true">Add new song list</el-button>
      </div>
          ...
          <template slot-scope="scope">
            <img :src="getUrl(scope.row.pic)" alt="" style="width: 80px;"/>
              <el-upload
                ...
                >
                <el-button size="mini">Update</el-button>
              </el-upload>
          </template>
        </el-table-column>
    ...
    <el-dialog title="添加歌单" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="addsongList">Yes</el-button>
      </span>
    </el-dialog>
