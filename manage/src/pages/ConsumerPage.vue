  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-button type="primary" size="mini" @click="centerDialogVisible = true">Add new user</el-button>
      </div>
      <el-table :data="data" border size="mini" style="width: 100%" ref="multipleTable" height="550px" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="歌手图片" width="102" align="center">
          <template slot-scope="scope">
            ...
            <el-upload
              ...
              <el-button size="mini">Update picture</el-button>
            </el-upload>
          </template>
        </el-table-column>
        ...
        <el-table-column label="收藏" width="80" align="center">
            <template  slot-scope="scope">
                <el-button size="mini" @click="getCollect(data[scope.$index].id)">Collect</el-button>
            </template>
        </el-table-column>
    ...
    <el-dialog title="添加用户" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="mini" @click="addPeople">Yes</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="编辑" :visible.sync="editVisible" width="400px">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="editVisible = false">No</el-button>
        <el-button type="primary" size="mini" @click="saveEdit">Yes</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog title="提示" :visible.sync="delVisible" width="300px" center>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" type="primary" @click="deleteRow">Yes</el-button>
      </span>
    </el-dialog>
  </div>
</template>
