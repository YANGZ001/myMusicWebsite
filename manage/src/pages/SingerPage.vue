  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        <el-button class="handle-del mr10" type="primary" size="mini" @click="delAll">Delete in batch</el-button>
        <el-input v-model="select_word" class="handle-input mr10" size="mini" placeholder="筛选关键词"></el-input>
        <el-button type="primary" size="mini" @click="centerDialogVisible = true">Add new singer</el-button>
      </div>
    ...
    <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="400px" center>
      ...
      <span class="dialog-footer" slot="footer">
        ...
        <el-button type="primary" size="mini" @click="addsinger">Yes</el-button>
      </span>
    </el-dialog>
    ...
    saveEdit () {
      ...
      HttpManager.updateSingerMsg(params)
        .then(res => {
          if (res.code === 1) {
            this.getData()
            this.notify('Edit succeed', 'success')
          } else {
    ...
    deleteRow () {
      HttpManager.deleteSinger(this.idx)
        .then(res => {
          if (res) {
            this.getData()
            this.notify('Delete succeed', 'success')
          } else {
